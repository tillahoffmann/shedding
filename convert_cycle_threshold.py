...
if __name__ == "__main__":
    ...
    parser.add_argument('--format', choices=['plain', 'json'], default='json', help='output format')
    parser.add_argument('--log10', help='whether to apply a log10 transform to the values',
                        action='store_true')
    parser.add_argument('reference', type=parse_values, help='reference scale to convert from')
    parser.add_argument('target', type=parse_values, help='target scale to convert from')
